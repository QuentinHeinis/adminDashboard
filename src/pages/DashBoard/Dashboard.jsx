...
const MoneyCard = ({mainColor, lightColor, darkColor, icon, title, text}) => (<div className='w-full max-w-md h-64 rounded-xl flex flex-col overflow-hidden'>
...
const Dashboard = () => {
  ...
  return (
    <div className='py-12 px-10'>
      ...
      <div className='flex justify-center gap-2 flex-wrap gap-y-4'>
